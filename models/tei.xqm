...
declare function getCorpusById($queryParams as map(*)) as map(*) {
  ...
  let $meta := map{
    ...
    'keywords' : getKeywords($corpus, $lang) (: is a sequence :)
    }
  let $content := 
...
declare function getTextItemsById($queryParams as map(*)) as map(*) {
  ...
  let $meta := map{
    ...
    'keywords' : getKeywords($text, $lang) (: is a sequence :)
    }
  let $content := 
...
declare function getModel($queryParams) {
  ...
  let $meta := map{
    ...
    'keywords' : getKeywords($model, $lang) (: is a sequence :)
    }
  let $content := map {
...
declare function getBibliographicalWorksList($queryParams as map(*)) as map(*) {
  ...
  let $meta := map{
    ...
    'keywords' : getKeywords($bibliography, $lang), (: is a sequence :)
